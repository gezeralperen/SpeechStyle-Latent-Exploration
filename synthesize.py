...
def synthesize(outdir, model, vocoder, text, sentence, speaker_embed, speaker_id, inspection, mel_raw, mel_len, f0, f0_norm, energy, duration_control=1.0, pitch_control=1.0, energy_control=1.0, write=True):
    ...
    if write:
        ...
        output = utils.vocoder_infer(mel_postnet_torch, vocoder, os.path.join(
            outdir, '{}_{}_{}.wav'.format("c", hp.vocoder, sentence)))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ckpt_path', type=str, default="ckpt/default/checkpoint_1190000.pth.tar")
