...
class StyleModeling(nn.Module):
    ...
    def forward(self, text, speaker_embed, mel_target, mel_aug, p_norm, e_input, src_len, mel_len, src_mask, mel_mask=None, duration_target=None, pitch_target=None, energy_target=None, max_len=None, d_control=1.0, p_control=1.0, e_control=1.0, seperate=False):
        ...
        if seperate:
            encoder_output = (text_encoding, pitch_embedding, speaker_encoding, energy_embedding)
        else:
            # Output
